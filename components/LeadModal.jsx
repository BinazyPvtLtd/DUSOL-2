...
export default function LeadModal({ open, setOpen }) {
  ...
  return (
    <div className="lead-modal open" aria-hidden={!open}>
      ...
      <div className="lead-box" role="dialog" aria-modal="true" aria-label="Book Free Counseling">
        <button className="lead-x" onClick={() => setOpen(false)} aria-label="Close">&times;</button>
        <h3>Book 100% Free Counseling</h3>
        <p className="lead-sub">Get 1 to 1 Expert Guidance from College Drishti</p>
        <form
