...
const img1 = '/assets/accreditationsImg/NAAC.webp'
const img2 = '/assets/accreditationsImg/UGC.webp'
const img3 = '/assets/accreditationsImg/AICTE.webp'
const img4 = '/assets/accreditationsImg/UGC.webp'
const img5 = '/assets/accreditationsImg/NIRF.webp'
...
function SpecializationContent ({ slug: slugProp }) {
  ...
  const {
    ...
    setPhone,
    handleSubmit
  } = useLeadForm({ source: 'Specialization Page' })
