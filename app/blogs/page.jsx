...
const BLOGS = [
  {
    ...
    excerpt: 'An Online MBA in Digital Marketing helps you master SEO, social media, analytics and growth strategy while you keep working. Here is everything you need to know before you enrol.',
    date: 'June 5, 2026',
    category: 'MBA',
  },
  {
    ...
    excerpt: 'Complete walkthrough of the DU SOL online admission process — from registration to document upload and fee payment. Avoid common mistakes with this step-by-step guide.',
    date: 'May 28, 2026',
    category: 'Admission',
  },
  {
    ...
    excerpt: 'A clear breakdown of the DU SOL examination pattern, marking scheme, assignment weightage and how to prepare effectively for your semester exams.',
    date: 'April 15, 2026',
    category: 'Exams',
  },
  {
    ...
    excerpt: 'Everything you need to know about DU online course admissions for 2026 — eligibility, available programs, fees and how to apply with free expert support.',
    date: 'April 14, 2026',
    category: 'Admission',
  },
  {
    ...
    excerpt: 'Detailed fee breakdown for the DU SOL Online MBA — application fee, semester fee, exam fee and total cost. Compare with other universities and understand scholarship options.',
    date: 'April 9, 2026',
    category: 'Fees',
  },
  {
    ...
    excerpt: 'Learn how to raise a grievance, track your complaint and get support from DU SOL — covering portal issues, fee problems, study material queries and exam concerns.',
    date: 'April 7, 2026',
    category: 'Support',
  },
  {
    ...
    excerpt: 'How DU SOL programs are ideal for students preparing for UPSC, SSC, banking exams and other competitive tests — study at your pace while continuing exam preparation.',
    date: 'April 2, 2026',
    category: 'Admission',
  },
]
    ...
    <div className="blog-card">
      <div className="blog-thumb">
        <svg viewBox="0 0 86 86" fill="none">
          <rect x="13" y="10" width="60" height="66" rx="6" fill="rgba(255,255,255,.15)"/>
          <rect x="21" y="24" width="44" height="6" rx="3" fill="rgba(255,255,255,.5)"/>
          <rect x="21" y="36" width="44" height="4" rx="2" fill="rgba(255,255,255,.35)"/>
          <rect x="21" y="46" width="30" height="4" rx="2" fill="rgba(255,255,255,.25)"/>
          <circle cx="67" cy="62" r="12" fill="#f7c615"/>
          <path d="M62 62l3.5 3.5L72 59" stroke="#43205f" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
        </svg>
      ...
      <div className="bc-body">
        ...
        <div className="bc-foot">
          <span>{blog.date}</span>
          <Link href={`/blog/${blog.slug}`} style={{ color: 'var(--purple)', fontWeight: 600, fontSize: '12px' }}>
            Read More →
          </Link>
        </div>
      </div>
    ...
    <>
      ...
      <section className="blog-hero">
        <div className="wrap">
          ...
          <p>Stay updated on DU SOL with our blog. Get the latest information on admissions, exams, online courses, eligibility and more. Your reliable source for DU SOL news.</p>
        </div>
      </section>
      ...
      <section className="still">
        <div className="wrap">
          <div className="still-box">
            ...
            <p>Get 100% free, personalised guidance from our experts — compare courses, check eligibility and find the right path for you.</p>
            <Link href="/blogs" className="btn btn-gold" style={{ marginTop: '18px' }}>
